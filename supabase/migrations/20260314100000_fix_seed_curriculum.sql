-- Fix: Seeding überspringt Nutzer mit kaputten/leeren Themen; App darf seed_curriculum_for_user aufrufen
...
begin
  ...
  -- Themen nur anlegen, wenn keines an ein bestehendes Fach gebunden ist
  if exists (
    select 1
...
-- Backfill erneut für alle Nutzer ohne verknüpfte Themen
do $$
declare
  r record;
begin
