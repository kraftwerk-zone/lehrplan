-- Unterthemen fehlten: seed_curriculum_for_user brach ab, sobald Themen existierten
-- (z. B. nach repair_my_curriculum, das nur Themen neu anlegte).
...
begin
  ...
  if linked_topics > 0 and linked_sub_topics > 0 then
    return;
  end if;
...
-- Bestehende Nutzer: fehlende Unterthemen nachziehen
do $$
declare
  r record;
begin
