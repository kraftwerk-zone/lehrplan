...
export function Planner() {
  ...
  // ---- Materials (files) — add/delete from the file view ------------------

  function addMaterial(topicId: string, subTopicId: string, name: string, folder: string) {
        ...
        t.id === topicId
          ? {
              ...
              children: t.children.map((st) =>
                st.id === subTopicId ? { ...st, materials: [...st.materials, material] } : st,
              ),
            }
          : t,
      ),
  ...
  function deleteMaterial(topicId: string, subTopicId: string, materialId: string) {
    setTopics((prev) =>
      prev.map((t) =>
        t.id === topicId
          ? {
