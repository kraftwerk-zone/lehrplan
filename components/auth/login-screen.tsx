...
import { CalendarRange, Eye, EyeOff, Loader2, LogIn } from "lucide-react"
        ...
        <div className="w-full max-w-sm">
          ...
          <form onSubmit={handleSubmit} className="mt-8 flex flex-col gap-4" noValidate>
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <div className="relative">
                <input
                  ...
                  placeholder="••••••••"
                  disabled={loading}
                  className="w-full rounded-md border border-border bg-background px-3 py-2 pr-10 text-sm text-foreground outline-none focus:ring-2 focus:ring-ring disabled:opacity-60"
                />
                <button
                  type="button"
            ...
            <button
              type="submit"
              disabled={loading}
              className="mt-2 inline-flex items-center justify-center gap-2 rounded-md bg-primary px-4 py-2 text-sm font-medium text-primary-foreground transition-opacity hover:opacity-90 disabled:opacity-60"
            >
